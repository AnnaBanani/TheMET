...
class LoadingPlaceholderView: UIView {
    ...
    private func setup(configuration: LoadingPlaceholderConfiguration) {
        ...
        if let buttonTitle = configuration.buttonTitle {
            self.button.apply(backgroundColor: UIColor(named: "blueberry"), fontColor: UIColor(named: "pear"), font: NSLocalizedString("san_serif_font", comment: ""), fontSize: 20, buttonTitle: buttonTitle)
